/*
 *
 * CaloHitObject.cc source template automatically generated by a class generator
...
CaloHitObject::CaloHitObject(CaloHit *pCaloHit) :
  m_pCaloHit(pCaloHit)
{
...
CaloHitObject::~CaloHitObject()
{

}


pandora::StatusCode CaloHitObject::MergeContentInCluster(const pandora::Algorithm &algorithm, pandora::Cluster *pCluster)
{
...
pandora::StatusCode CaloHitObject::CreateCluster(const pandora::Algorithm &algorithm, pandora::Cluster *&pCluster)
{
