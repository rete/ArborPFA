/*
 *
 * SmallClusterObject.cc source template automatically generated by a class generator
...
SmallClusterObject::SmallClusterObject(Cluster *pCluster) :
  m_pCluster(pCluster),
		m_clusterAlreadyCreated(false),
		m_alreadyMergeContent(false)
{

	m_type = ArborObject::SMALL_CLUSTER;
...
SmallClusterObject::~SmallClusterObject() 
{

}


pandora::StatusCode SmallClusterObject::MergeContentInCluster(const pandora::Algorithm &algorithm, pandora::Cluster *pCluster)
{
...
pandora::StatusCode SmallClusterObject::CreateCluster(const pandora::Algorithm &algorithm, pandora::Cluster *&pCluster)
{
