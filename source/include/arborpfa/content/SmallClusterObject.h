/*
 *
 * SmallClusterObject.h header template automatically generated by a class generator
...
/** 
 * @brief SmallClusterObject class
 */ 
class SmallClusterObject : public ArborObjectImpl
{
 public:
		...
		/**
			* @brief Constructor
			*/
		SmallClusterObject(pandora::Cluster *pCluster);

		/**
			* @brief Destructor
			*/
		virtual ~SmallClusterObject();
...
inline pandora::Cluster *SmallClusterObject::GetCluster() const
{
	return m_pCluster;
}


inline unsigned int SmallClusterObject::GetSize() const
{
