/*
 *
 * SimpleCaloHitObject.h header template automatically generated by a class generator
...
/** 
 * @brief SimpleCaloHitObject class
 */ 
class SimpleCaloHitObject : public ArborObjectImpl
{
 public:
	...
	/**
		* @brief Constructor
		*/
	SimpleCaloHitObject(pandora::CaloHit *pCaloHit);

	/**
		* @brief Dtor
		*/
	virtual ~SimpleCaloHitObject();
...
inline pandora::CaloHit *SimpleCaloHitObject::GetCaloHit() const
{
	return m_pCaloHit;
}
