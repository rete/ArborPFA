...
public:
    ...
    public:
        ...
        bool            m_shouldUseSDHCALData;                  ///< True if the hcal collections are coming from SDHCAL data (sim or TB)
    };
...
private:
    ...
    /**
     * @brief  Map the sdhcal calo hit coming from data (sim or TB) to hcal endcap module
     *
     * @param  The cell id for I
     * @param  The cell id for J
     * @param  The cell id for K
     * @param  The calo hit position to map
     */
    pandora::StatusCode ConvertSdhcalIJKToPositionVector(unsigned int I, unsigned int J, unsigned int K, pandora::InputCartesianVector &vec) const;
    ...
    const float                         m_hCalEndCapInnerR;                 ///< HCal endcap inner r coordinate
