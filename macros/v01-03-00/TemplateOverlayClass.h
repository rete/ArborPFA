...
// Tue Oct 21 14:43:28 2014 by ROOT version 5.34/05
// from TTree PfoMonitoring/PfoMonitoring
// found on file: ../../ArborPFAOutput.root
//////////////////////////////////////////////////////////

#ifndef TemplateOverlayClass_h
#define TemplateOverlayClass_h
...
public :
   ...
   TemplateOverlayClass(TTree *tree=0);
   virtual ~TemplateOverlayClass();
...
#ifdef TemplateOverlayClass_cxx
TemplateOverlayClass::TemplateOverlayClass(TTree *tree) : fChain(0) 
{
...
TemplateOverlayClass::~TemplateOverlayClass()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t TemplateOverlayClass::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t TemplateOverlayClass::LoadTree(Long64_t entry)
{
...
void TemplateOverlayClass::Init(TTree *tree)
{
...
Bool_t TemplateOverlayClass::Notify()
{
...
void TemplateOverlayClass::Show(Long64_t entry)
{
...
Int_t TemplateOverlayClass::Cut(Long64_t entry)
{
...
#endif // #ifdef TemplateOverlayClass_cxx
