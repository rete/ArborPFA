...
#ifndef SinglePurityAnalysis_h
#define SinglePurityAnalysis_h
...
public :
   ...
   SinglePurityAnalysis(TTree *tree=0);
   virtual ~SinglePurityAnalysis();
...
#ifdef SinglePurityAnalysis_cxx
SinglePurityAnalysis::SinglePurityAnalysis(TTree *tree) : fChain(0)
{
...
SinglePurityAnalysis::~SinglePurityAnalysis()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t SinglePurityAnalysis::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t SinglePurityAnalysis::LoadTree(Long64_t entry)
{
...
void SinglePurityAnalysis::Init(TTree *tree)
{
...
Bool_t SinglePurityAnalysis::Notify()
{
...
void SinglePurityAnalysis::Show(Long64_t entry)
{
...
Int_t SinglePurityAnalysis::Cut(Long64_t entry)
{
...
#endif // #ifdef SinglePurityAnalysis_cxx
