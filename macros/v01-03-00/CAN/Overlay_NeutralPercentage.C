...
void Overlay_NeutralPercentage()
{
   std::string canvasName = "canvas";
   std::string canvasTitle = "Neutral percentage";
   int canvasX1 = 200;
   int canvasY1 = 52;
   int canvasX2 = 700;
   int canvasY2 = 650;
   ...
   for(unsigned int e=0 ; e<nGraphs ; e++)
   {
     ...
     fileName << "data_neutralPercentage_ArborPFA_Test\ Beam_" << energy << "Gev.txt";
