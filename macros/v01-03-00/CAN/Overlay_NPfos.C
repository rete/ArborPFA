...
void Overlay_NPfos()
{
   ...
   for(unsigned int e=0 ; e<nGraphs ; e++)
   {
     ...
     fileName << "data_npfos_ArborPFA_Test Beam_" << energy << "Gev.txt";
     ...
     entry=leg->AddEntry(gre, graphName.str().c_str(), "pl");
