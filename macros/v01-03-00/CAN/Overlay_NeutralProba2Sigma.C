...
void Overlay_NeutralProba2Sigma()
{
   ...
   std::string graphYTitle = "2 #sigma event fraction of E_{n}";
   ...
   for(unsigned int e=0 ; e<nGraphs ; e++)
   {
     ...
     fileName << "data_neutralProba2Sigma_ArborPFA_Test\ Beam_" << energy << "Gev.txt";
