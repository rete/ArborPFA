...
void Overlay_NeutralPurity()
{
   std::string canvasName = "canvas";
   std::string canvasTitle = "Neutral Purity";
   int canvasX1 = 200;
   int canvasY1 = 52;
   int canvasX2 = 700;
   int canvasY2 = 650;
   ...
   std::string graphYTitle = "#rho_{neutral}";
   ...
   for(unsigned int e=0 ; e<nGraphs ; e++)
   {
     ...
     fileName << "data_neutralPurity_ArborPFA_Test\ Beam_" << energy << "Gev.txt";
