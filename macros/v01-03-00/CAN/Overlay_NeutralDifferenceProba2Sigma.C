...
void Overlay_NeutralDifferenceProba2Sigma()
{
   ...
   std::string graphYTitle = "2 #sigma event fraction of E_{n} difference";
   ...
   for(unsigned int e=0 ; e<nGraphs ; e++)
   {
     ...
     fileName << "data_neutralDifferenceProba2Sigma_ArborPFA_Test\ Beam_" << energy << "Gev.txt";
