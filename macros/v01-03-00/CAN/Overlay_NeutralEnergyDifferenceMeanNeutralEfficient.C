...
void Overlay_NeutralEnergyDifferenceMeanNeutralEfficient()
{
   ...
   std::string graphYTitle = "<E_{n,rec} - E_{n,meas}>, n>0 [GeV]";
   ...
   for(unsigned int e=0 ; e<nGraphs ; e++)
   {
     ...
     fileName << "data_neutralERecDifferenceNeutralEfficient_ArborPFA_Test\ Beam_" << energy << "Gev.txt";
