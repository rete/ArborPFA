...
void Overlay_NeutralDifferenceProba1Sigma()
{
   ...
   std::string graphYTitle = "1 #sigma event fraction of E_{n} difference";
   ...
   for(unsigned int e=0 ; e<nGraphs ; e++)
   {
     ...
     fileName << "data_neutralDifferenceProba1Sigma_ArborPFA_Test\ Beam_" << energy << "Gev.txt";
